...
def generate_key(plaintext_key: str, salt: bytes) -> bytes:
...
def encrypt(payload: bytes, plaintext_key: str) -> bytes:
    ...
    key = generate_key(plaintext_key, key_salt)
...
def decrypt(seal: bytes, plaintext_key: str) -> bytes:
